...
def do_system(arg):
	print(f"==== running: {arg}")
	# print(win32api.MessageBox(0,"transform.json开始生成","提醒",win32con.MB_SYSTEMMODAL))
	err = os.system(arg)
	if err:
		print("FATAL: command failed")
		print(win32api.MessageBox(0,"transform.json生成失败","警告",win32con.MB_SYSTEMMODAL))
		sys.exit(err)
...
def run_colmap(args):
	...
	print(win32api.MessageBox(0,"创建colmap文件夹","提醒",win32con.MB_SYSTEMMODAL))
...
if __name__ == "__main__":
	...
	print(win32api.MessageBox(0,"开始计算cameras位姿信息","提醒",win32con.MB_SYSTEMMODAL))
	...
	print(f"camera:\n\tres={w,h}\n\tcenter={cx,cy}\n\tfocal={fl_x,fl_y}\n\tfov={fovx,fovy}\n\tk={k1,k2} p={p1,p2} ")
	# print(win32api.MessageBox(0,"参数计算完成","提醒",win32con.MB_SYSTEMMODAL))
	...
	# print(win32api.MessageBox(0,"computing center of attention...","提醒",win32con.MB_SYSTEMMODAL))
	totw = 0.0
	...
	print(win32api.MessageBox(0,"transform.json已生成","提醒",win32con.MB_SYSTEMMODAL))
